...
Project Overview
    A professional-grade Test Automation Framework designed to validate the Lead Manager SaaS Application. 
This project demonstrates advanced QA engineering practices, including UI/API integration, Role-Based 
Access Control (RBAC) validation, and Data-Driven Testing.
